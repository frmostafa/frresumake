...
export default function DataListItem({data}) {
  return (
    ...
    <View >
        <Text><MaterialIcons name="location-city" style={styles.iconStyle} size={20} color="black" />{data.secondary}</Text>
    </View>
    <View style={styles.dataListTextLineTwo}>
        <Text><MaterialCommunityIcons name="calendar-clock" size={20} color="black" /> {data.startDate} - {data.endDate}</Text>
        {/* <Text>-</Text> */}
        <Text></Text>
        <Text><EvilIcons name="location" size={20} color="black" /> {data.city},{data.country}</Text>
    </View>
  </View>  )
}
